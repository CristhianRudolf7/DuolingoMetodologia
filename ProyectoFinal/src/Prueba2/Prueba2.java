...
String[][] docentes=new String[10][3];
        ...
        while(continuar){
            ...
            if(opcion.equals("1")){
                ...
                for(int i=0;i<docentes.length;i++){
                    if(docentes[i][0]!=null&&docentes[i][0].equals(correo)&&docentes[i][1].equals(contraseña)){
                        esDocente=true;
                        dindice=i;
                        break;}}
                if(esDocente){
                    String menuDocente="Bienvenido, docente:\n";
                    menuDocente+="Nombre: "+docentes[dindice][2]+"\n";
                    menuDocente+="Correo: "+docentes[dindice][0]+"\n";

while (true) {
            opcion = JOptionPane.showInputDialog(menuDocente+"¿Qué deseas realizar?\n1. Traducir del inglés al español\n2. Traducir del español al inglés\n0. Salir");
            if (opcion.equals("1")) {
                ...
                String correoElectronico=nombre + apellido + "@gmail.com";
                    for(int i=0;i<docentes.length;i++){
                        if (docentes[i][0]==null){
                            docentes[i][0]=correoElectronico;
                            docentes[i][1]=contraseñaNueva;
                            docentes[i][2]=nombre + " " + apellido;
                            break; } }
