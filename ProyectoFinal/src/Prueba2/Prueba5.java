...
public static CalificacionUsuario traducirEspanolIngles(List<String> verbosIngles, List<String> traduccionesEspanol) {
   ...
   public static void verCalificaciones(Usuario usuario) {
    ...
    StringBuilder mensaje = new StringBuilder("Calificaciones de " + usuario.getNombre() + ":\n");
    int i=0;
    for (CalificacionUsuario calificacion : calificaciones) {
        i++;
        mensaje.append("\nLas calificaiones del examen ").append(i).append(" son:\n");
        mensaje.append("Total de preguntas: ").append(calificacion.getPreguntasRealizadas()).append("\n");
    mensaje.append("Preguntas correctas: ").append(calificacion.getPreguntasCorrectas()).append("\n");
    ...
    mensaje.append("Porcentaje de acierto: ").append(porcentajeAcierto).append("%\n");
    }
